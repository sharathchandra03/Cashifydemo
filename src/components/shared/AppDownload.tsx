...
export default function AppDownload() {
  return (
    <section className="py-10 md:py-14 bg-[#FBFBFD]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="rounded-3xl teal-gradient overflow-hidden relative">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-[rgba(0,113,227,0.15)] blur-2xl" />
          </div>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 px-6 md:px-12 py-10 md:py-12">
            ...
            <div className="flex-1 text-white text-center lg:text-left">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                ...
                <a
                  href="#"
                  className="flex items-center gap-2 bg-white text-[#1D1D1F] px-4 py-2.5 rounded-xl hover:bg-white/90 transition-colors shadow-lg"
                >
            ...
            <div className="relative flex-shrink-0 w-48 md:w-56">
              ...
              {/* Glow */}
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-12 bg-[rgba(0,113,227,0.4)] blur-xl rounded-full" />
            </div>
          </div>
        </div>
      </div>
