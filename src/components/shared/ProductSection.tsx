  ...
  return (
    <div className="group relative w-52 shrink-0 cursor-pointer rounded-2xl border border-border bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
      ...
      <div className="absolute top-3 left-3 z-10">
        <Badge className="bg-[oklch(0.68_0.19_45)] text-white border-0 text-[10px] font-bold px-2 py-0.5 shadow-sm">
          {product.discount}
        </Badge>
      </div>
      {/* Grade badge */}
      <div className="absolute top-3 right-3 z-10">
        <span className="bg-[oklch(0.6_0.18_195)] text-white text-[9px] font-bold px-1.5 py-0.5 rounded">
          Grade {product.grade}
        </span>
      </div>
      ...
      {/* Content */}
      <div className="p-3.5">
        <h3 className="font-semibold text-xs text-[oklch(0.15_0.01_240)] line-clamp-2 leading-snug mb-2">
          {product.name}
        </h3>
        ...
        <div className="flex items-baseline gap-1.5 mb-2.5">
          <span className="font-[family-name:var(--font-display)] font-bold text-base text-[oklch(0.6_0.18_195)]">
            {product.price}
          </span>
    ...
    <section className={`py-12 md:py-16 ${bgColor} overflow-hidden`}>
      <div className="max-w-7xl mx-auto px-4 mb-6 md:mb-8">
        ...
        <div className="flex items-end justify-between">
          <div>
            <h2 className="font-[family-name:var(--font-display)] text-xl md:text-3xl text-[oklch(0.12_0.01_240)]" style={{ fontWeight: 500 }}>
              {title}
            </h2>
          ...
          <Link
            href={viewAllHref}
            className="hidden sm:flex items-center gap-1 text-sm font-semibold text-[oklch(0.6_0.18_195)] hover:underline shrink-0 ml-4"
          >
      ...
      <div className="mt-6 text-center sm:hidden px-4">
        <Link
          href={viewAllHref}
          className="inline-flex items-center gap-2 border-2 border-[oklch(0.6_0.18_195)] text-[oklch(0.6_0.18_195)] font-semibold px-6 py-2.5 rounded-xl transition-colors hover:bg-[oklch(0.96_0.01_195)]"
        >
