        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-muted-foreground">
              <p className="mb-4">
                Founded in 2016, MobiTrade started with a simple mission: to solve the problem of trustworthy device resale in India.
              ...
              {values.map((v) => (
                <div key={v.title} className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#F5F5F7] flex items-center justify-center shrink-0">
                    <v.icon className="h-6 w-6 text-[#3478F6]" />
                  </div>
                  <div>
