    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {branchesData.map((branch) => (
          <div key={branch.id} className="bg-white rounded-2xl border-2 border-border p-5 hover:border-[oklch(0.6_0.18_195)] transition-colors">
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 rounded-xl bg-[oklch(0.97_0.01_195)] flex items-center justify-center">
                <Building2 className="h-6 w-6 text-[oklch(0.6_0.18_195)]" />
              </div>
              <span className={cn(
            ...
            <h3 className="font-semibold text-[oklch(0.15_0.01_240)] mb-1">{branch.name}</h3>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-[oklch(0.98_0.005_240)] rounded-lg p-2.5">
                <p className="text-lg font-bold text-[oklch(0.12_0.01_240)]">{branch.staff}</p>
                <p className="text-xs text-muted-foreground">Staff</p>
              </div>
              <div className="bg-[oklch(0.98_0.005_240)] rounded-lg p-2.5">
                <p className="text-lg font-bold text-[oklch(0.12_0.01_240)]">{branch.inventory}</p>
                <p className="text-xs text-muted-foreground">Inventory</p>
              </div>
              <div className="bg-[oklch(0.98_0.005_240)] rounded-lg p-2.5">
                <p className="text-lg font-bold text-[oklch(0.12_0.01_240)]">{branch.sales}</p>
                <p className="text-xs text-muted-foreground">Sales</p>
              </div>
              <div className="bg-[oklch(0.98_0.005_240)] rounded-lg p-2.5">
                <p className="text-lg font-bold text-[oklch(0.6_0.18_195)]">₹{(branch.revenue / 100000).toFixed(1)}L</p>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border">
              <div>
                ...
                <p className="text-sm font-medium text-[oklch(0.15_0.01_240)]">{branch.manager}</p>
              </div>
              <button className="p-2 rounded-lg hover:bg-[oklch(0.97_0.01_195)] text-[oklch(0.6_0.18_195)]">
          ...
          <div className="relative bg-white rounded-2xl p-6 w-full max-w-lg">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input className="w-full px-3 py-2.5 rounded-xl border-2 border-border focus:border-[oklch(0.6_0.18_195)] focus:outline-none" placeholder="Enter branch name" />
              </div>
              <div>
                <label className="text-sm font-medium mb-1.5 block">Address</label>
                <textarea className="w-full px-3 py-2.5 rounded-xl border-2 border-border focus:border-[oklch(0.6_0.18_195)] focus:outline-none resize-none" rows={3} placeholder="Complete address" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input className="w-full px-3 py-2.5 rounded-xl border-2 border-border focus:border-[oklch(0.6_0.18_195)] focus:outline-none" placeholder="Manager name" />
                </div>
              </div>
              <div className="flex gap-3 pt-2">
                ...
                <button type="submit" onClick={(e) => { e.preventDefault(); setShowAddModal(false); }} className="flex-1 py-2.5 bg-[oklch(0.6_0.18_195)] text-white rounded-xl font-medium hover:bg-[oklch(0.55_0.18_195)]">Add Branch</button>
              </div>
            </form>
          </div>
        </div>
