        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <div className="w-24 h-24 rounded-full bg-[#F5F5F7] flex items-center justify-center mx-auto mb-6">
              <ShoppingBag className="h-12 w-12 text-[#3478F6]" />
            </div>
            <h1 className="font-[family-name:var(--font-display)] font-bold text-2xl mb-2">Your Cart is Empty</h1>
            <p className="text-muted-foreground mb-6">Looks like you haven&apos;t added anything yet</p>
            <Link
              href="/buy"
              className="inline-flex items-center gap-2 bg-[#3478F6] text-white px-6 py-3 rounded-xl font-semibold hover:bg-[#1D5FD8]"
            >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {cart.map((item) => (
                <div key={item.id} className="bg-white rounded-2xl border-2 border-border p-4 flex gap-4">
                  <div className="w-24 h-24 bg-[#FBFBFD] rounded-xl flex items-center justify-center shrink-0">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-2 border-2 border-border rounded-lg hover:bg-[#FBFBFD]"
                        >
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-2xl border-2 border-border p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between pt-3 border-t border-border">
                    ...
                    <span className="font-bold text-xl text-[#3478F6]">₹{total.toLocaleString()}</span>
                  </div>
                </div>

                <Link
                  href="/checkout"
                  className="w-full mt-6 py-3 bg-[#3478F6] text-white rounded-xl font-semibold hover:bg-[#1D5FD8] flex items-center justify-center gap-2"
                >
              ...
              <div className="bg-gradient-to-br from-[#FFF9F5] to-[#FFF5F0] rounded-2xl p-4">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button className="px-4 py-2 bg-[#3478F6] text-white rounded-lg text-sm font-medium">
                    Apply
                  </button>
                </div>
              </div>
