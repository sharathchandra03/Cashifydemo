...
const blogPosts = [
  ...
  { id: "3", title: "How We Grade Our Devices: The MobiTrade Process", excerpt: "Inside look at our quality inspection standards.", image: "https://images.unsplash.com/photo-1588515603068-48e855d27f70?w=400", date: "Jan 8, 2024", readTime: "4 min", category: "Process" },
    ...
    <div className="min-h-screen flex flex-col bg-[#FBFBFD]">
      ...
      <main className="flex-1">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                  cat === "All"
                    ...
                    : "bg-white border-2 border-border hover:border-[#3478F6]"
                }`}
              >
                {cat}
              </button>
        ...
        <section className="max-w-6xl mx-auto px-4 pb-12">
          <Link href="#" className="block bg-white rounded-2xl border-2 border-border overflow-hidden hover:border-[#3478F6] transition-colors">
            <div className="grid md:grid-cols-2">
              <div className="relative h-64 md:h-auto">
                <Image src={featuredPost.image} alt={featuredPost.title} fill className="object-cover" />
              </div>
              <div className="p-6 md:p-8 flex flex-col justify-center">
                <span className="inline-flex items-center gap-1 text-sm text-[#3478F6] font-medium mb-3">
                ...
                <span className="inline-flex items-center gap-2 text-[#3478F6] font-medium">
        ...
        <section className="max-w-6xl mx-auto px-4 pb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {blogPosts.map((post) => (
              <Link key={post.id} href="#" className="bg-white rounded-2xl border-2 border-border overflow-hidden hover:border-[#3478F6] transition-colors group">
                ...
                <div className="p-5">
                  <h3 className="font-semibold mb-2 line-clamp-2 group-hover:text-[#3478F6] transition-colors">
                    {post.title}
                  </h3>
