    ...
    <div className="min-h-screen flex flex-col bg-[#FBFBFD]">
      ...
      <main className="flex-1">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {steps.map((step, i) => (
                <div key={step.title} className="text-center">
                  <div className="w-20 h-20 rounded-2xl bg-[#3478F6] flex items-center justify-center mx-auto mb-6">
                    <step.icon className="h-10 w-10 text-white" />
                  </div>
                  <div className="w-8 h-8 rounded-full bg-[#0071E3] text-white font-bold flex items-center justify-center mx-auto mb-4">
                    {i + 1}
                  </div>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="font-[family-name:var(--font-display)] font-bold text-2xl text-center mb-12">
              The MobiTrade Promise
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {guarantees.map((g) => (
                <div key={g.title} className="p-6 rounded-2xl bg-[#FBFBFD] text-center">
                  <g.icon className="h-8 w-8 text-[#3478F6] mx-auto mb-4" />
        ...
        <section className="py-16 px-4 text-center">
          ...
          <Link
            href="/sell"
            className="inline-flex items-center gap-2 bg-[#3478F6] text-white font-semibold px-8 py-3 rounded-xl hover:bg-[#1D5FD8] transition-colors"
          >
            Get Price Now
          </Link>
        </section>
